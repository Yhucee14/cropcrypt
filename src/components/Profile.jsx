...
const Profile = () => {
  ...
  return (
    <div className="">
      ...
      <Link to="/" className="md:px-4 lg:px-12 flex py-5 flex-row gap-4">
      ...
      <div className=" relative flex justify-center items-center flex-col">
        ...
        <div className="absolute bottom-[-50px] md:left-[10%] lg:left-[15%]">
      ...
      <div className="md:px-5 lg:px-36">
        ...
        <div className="border-2 border-[#736D6D66] rounded-lg flex flex-row py-4 justify-between">
          ...
          <div className="flex flex-col border-x-2 border-[#736D6D66] justify-center items-center px-5 w-full">
            <div className="font-normal">Market Cap</div>
            <div className="font-bold text-lg">112</div>
          </div>

          <div className="flex flex-col w-full justify-center items-center">
            <div>Share Holders (Token)</div>
            <div className="font-bold text-lg">112</div>
          </div>
        </div>
