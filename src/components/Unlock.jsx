...
const Unlock = () => {
  return (
    <div className="flex py-5 relative flex-col justify-center">
      <div className="flex flex-col justify-center items-center font-bold text-3xl py-5">
        <p className="px-1 ">
      ...
      <div className="absolute md:top-[-40px] lg:top-[-50px] md:right-[-120px] lg:right-0">
        <img src={greenx} alt="home" className="md:w-32 md:h-32 lg:w-40 lg:h-40 z-20" />
      </div>

      <div className="flex flex-row justify-between md:gap-10 lg:gap-2">
        ...
        <div className="absolute md:top-[290px] lg:top-[240px] md:left-[330px] lg:left-[430px]">
