...
const Discover = () => {
  return (
    <div className="flex py-8 flex-col xx:px-3 md:px-0 justify-center items-center">
      ...
      <div className="flex xx:gap-6 sm:gap-2 xx:flex-col sm:flex-row py-3">
        <div className="flex flex-col md:w-52 lg:w-64  px-3 py-4 bg-[#F4F4F4] rounded-2xl border border-gray-400">
          <p className="font-bold text-lg sm:text-2xl"> Invest stable coins with ease</p>
        ...
        <div className="flex flex-col md:w-52 lg:w-64 px-2 sm:px-3 py-4 bg-[#F4F4F4] rounded-2xl border border-gray-400">
        ...
        <div className="flex flex-col md:w-52 lg:w-64 px-3 py-2 justify-center items-center bg-[#F4F4F4] rounded-2xl border border-gray-400">
          <p className="font-bold mt-[-0px] text-lg sm:text-2xl">
