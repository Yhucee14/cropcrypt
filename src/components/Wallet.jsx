...
const Wallet = () => {
  return (
    <div className=" flex md:gap-16 lg:gap-0 flex-row items-center justify-between rounded-lg py-10 lg:py-16 lg:px-7">
      <div className="px-5 py-2">
        <img src={key} alt="home" className=" z-20" />
      </div>

      <div className="lg:w-[500px] md:w-[500px] lg:px-5">
